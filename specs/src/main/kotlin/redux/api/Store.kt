...
interface Store<S : Any> : Dispatcher {
     ...
     */
    // TODO : API bug. A creator can creator for any type.
    // Only the reducer decides the type to be dispatched
    interface Creator {
     ...
     */
    // TODO : API bug. Enhancer may enhance the reducer hence lift its state's type
    // Only the reducer decides the type to be dispatched
    interface Enhancer {
